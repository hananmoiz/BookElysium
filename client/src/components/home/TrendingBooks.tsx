    ...
    <section className="py-16 bg-white">
      <div className="container mx-auto px-4">
        <div className="flex justify-between items-center mb-10">
          <h2 className="font-heading text-3xl font-bold">Trending This Week</h2>
            ...
            <div className="inline-flex space-x-6 min-w-full">
              {isLoading ? (
                ...
                <div className="w-full text-center py-10 text-destructive">
                  <p>Failed to load trending books. Please try again later.</p>
                </div>
              ) : books?.length === 0 ? (
                <div className="w-full text-center py-10 text-muted-foreground">
                  <p>No trending books found at the moment. Check back later!</p>
                </div>
              ) : (
                books?.map((book) => (
